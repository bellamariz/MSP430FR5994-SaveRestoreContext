...
fram-utilities/ctpl/peripherals/%.obj: ../fram-utilities/ctpl/peripherals/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"C:/ti/ccs1230/ccs/tools/compiler/ti-cgt-msp430_21.6.1.LTS/bin/cl430" -vmspx --data_model=restricted --use_hw_mpy=F5 --include_path="C:/ti/ccs1230/ccs/ccs_base/msp430/include" --include_path="C:/Users/AdmGistLab2/Documents/msp430novo/CTPLTest" --include_path="C:/Users/AdmGistLab2/Documents/msp430novo/CTPLTest/fram-utilities/ctpl" --include_path="C:/ti/ccs1230/ccs/tools/compiler/ti-cgt-msp430_21.6.1.LTS/include" --advice:power=all --advice:hw_config=all --define=__MSP430FR5994__ --define=_MPU_ENABLE --define=CTPL_STACK_SIZE=160 -g --printf_support=minimal --diag_warning=225 --diag_wrap=off --display_error_number --silicon_errata=CPU21 --silicon_errata=CPU22 --silicon_errata=CPU40 --preproc_with_compile --preproc_dependency="fram-utilities/ctpl/peripherals/$(basename $(<F)).d_raw" --obj_directory="fram-utilities/ctpl/peripherals" $(GEN_OPTS__FLAG) "$<"
